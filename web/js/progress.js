...
function emptyBucket() {
  return { reviewed: 0, correct: 0, seconds: 0, vocab: 0, grammar: 0, score: 0, updated: 0 };
}
...
export function recordActivity(state, { deviceId, content, grade, seconds = 0, points = 0, now = Date.now() }) {
