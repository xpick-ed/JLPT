...
const CACHE = 'jlpt-pwa-v19';   // bump on each release to refresh the shell
const SHELL = [
  './', './index.html', './style.css', './config.js', './manifest.json',
  './js/app.js', './js/ui.js', './js/store.js', './js/session.js', './js/srs.js', './js/progress.js',
  './js/audio.js', './js/bgm.js', './js/combo.js', './js/achievements.js', './js/stats.js', './js/vocab-test.js', './js/exam.js', './js/sync.js', './js/auth.js', './js/furigana.js',
