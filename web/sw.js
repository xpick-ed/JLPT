...
const CACHE = 'jlpt-pwa-v21';   // bump on each release to refresh the shell
const SHELL = [
  ...
  './js/modes/match.js', './js/modes/typing.js', './js/modes/quiz.js', './js/modes/listening.js', './js/modes/vocab-cloze.js', './js/modes/particle.js',
