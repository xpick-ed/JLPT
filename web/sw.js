...
const CACHE = 'jlpt-pwa-v25';   // bump on each release to refresh the shell
const SHELL = [
  ...
  './js/modes/match.js', './js/modes/typing.js', './js/modes/quiz.js', './js/modes/listening.js', './js/modes/vocab-cloze.js', './js/modes/particle.js', './js/modes/homophone.js', './js/modes/dictation.js', './js/modes/shadow.js', './js/modes/conjug.js', './js/conjugate.js',
